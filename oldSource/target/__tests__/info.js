...
describe('getTypeChecker()', () => {
  describe('When no target passed', () => {
    it('should result with undefined', () => {
      expect(getTypeChecker()).toBeUndefined();
    });
  });
  ...
  describe('When target has info', () => {
    describe('When target does not have type checker', () => {
      it('should result with undefined', () => {
        expect(getTypeChecker({ [INFO_KEY]: { type: 'info-object' } })).toBeUndefined();
      });
    });
    ...
    describe('When target has type checker', () => {
      ...
      it('should result with undefined', () => {
        expect(getTypeChecker({ [INFO_KEY]: { checker } })).toBe(checker);
      });
    });
  });
  ...
  describe('When target does not have info', () => {
    it('should result with undefined', () => {
      expect(getTypeChecker({ info: {} })).toBeUndefined();
    });
  });
});

describe('getTypeCheckerData()', () => {
  describe('When no target passed', () => {
    it('should result with undefined', () => {
      expect(getTypeCheckerData()).toBeUndefined();
    });
  });
  ...
  describe('When target has info', () => {
    describe('When target does not have type checker', () => {
      it('should result with undefined', () => {
        expect(getTypeCheckerData({ [INFO_KEY]: { type: 'info-object' } })).toBeUndefined();
      });
    });
    ...
    describe('When target has type checker', () => {
      ...
      it('should result with undefined', () => {
        expect(getTypeCheckerData({ [INFO_KEY]: { config } })).toBe(config);
      });
    });
  });
  ...
  describe('When target does not have info', () => {
    it('should result with undefined', () => {
      expect(getTypeCheckerData({ info: {} })).toBeUndefined();
    });
  });
});
